...
$infraProj = Join-Path $PSScriptRoot '..\BanqueProjet.Infrastructure\BanqueProjet.Infrastructure.csproj'
$apiProj   = Join-Path $PSScriptRoot '..\BanqueProjet.API\BanqueProjet.API.csproj'
...
$efParams = @(
    ...
    '--context-dir', 'Data',
    '--output-dir', "..\BanqueProjet.Infrastructure\Entities",
    '--context', 'BanquePDbContext',
    '--data-annotations',
