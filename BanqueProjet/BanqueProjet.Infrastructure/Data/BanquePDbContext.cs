...
public partial class BanquePDbContext : DbContext
{
    ...
    public virtual DbSet<OViewLivrablesDuProjet> OViewLivrablesProjet { get; set; }

    public virtual DbSet<OViewAspectsJuridique> OViewAspectsJuridiques { get; set; }

    public virtual DbSet<OViewBailleursDeFond> ViewProjetBailleursPlats { get; set; }
    ...
    public virtual DbSet<OViewIformationsFinancierePrevision> OViewIformationsFinancierePrevisions { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OViewLivrablesDuProjet>(eb =>
            {
                eb.HasNoKey();
                eb.ToView("O_VIEW_LIVRABLES_DU_PROJET");
            });

        modelBuilder.Entity<OViewIformationsFinancierePrevision>(eb =>
        {
            eb.HasNoKey();
            eb.ToView("O_VIEW_INFORMATIONS_FINANCIERES_T");
        });
